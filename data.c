...
//canopy
			...
			DAVecGetArray(fda, user[bi].CnpyF, &cnpyForce);
				numbytes = sizeof(double)*(xe-2-xs)*(ye-2-ys)*(ze-2-zs)*3;
				fwrite(&numbytes, sizeof(int), 1, f);
			...
			DAVecRestoreArray(fda, user[bi].CnpyF, &cnpyForce);

		        // PetscPrintf(PETSC_COMM_WORLD, "********** Loading CnpyNvert \n");
			DAVecGetArray(da,  user[bi].CnpyNvert, &cnpyNvert);
				numbytes = sizeof(double)*(xe-2-xs)*(ye-2-ys)*(ze-2-zs);
				fwrite(&numbytes, sizeof(int), 1, f);
			...
			DAVecRestoreArray(da,  user[bi].CnpyNvert, &cnpyNvert);

		        // PetscPrintf(PETSC_COMM_WORLD, "********** Loading CnpyCdy \n");
      DAVecGetArray(da,  user[bi].CnpyCdy, &cnpyCdy);
				numbytes = sizeof(double)*(xe-2-xs)*(ye-2-ys)*(ze-2-zs);
				fwrite(&numbytes, sizeof(int), 1, f);
					...
					for (j=ys; j<ye-2; j++) {
						for (i=xs; i<xe-2; i++) {
							...
							fwrite(&value, sizeof(value), 1, f);
                                ...
                                DAVecRestoreArray(da,  user[bi].CnpyCdy, &cnpyCdy);
	...
	for (bi=0; bi<block_number; bi++) {
		...
		*/
		...
		if (tempOpt == 1 && only_V!=2) {
                        PetscReal ***tfield;
                        DAVecGetArray(user[bi].da, user[bi].Temp, &tfield);
			...
			I = TECDAT100(&III, &x[0], &DIsDouble);
                        ...
                        DAVecRestoreArray(user[bi].da, user[bi].Temp, &tfield);
		}
		...
		if(conv_diff && sandwave) {
			...
			PetscViewerDestroy(viewer);
			DAVecGetArray(user[bi].da, lUstar_, &ustar_);
			...
			DAVecRestoreArray(user[bi].da, lUstar_, &ustar_);
			VecDestroy(lUstar_);
		}
		...
		if(conv_diff) {
			...
			PetscViewerDestroy(viewer);
			DAVecGetArray(user[bi].da, Conc, &conc);
			...
			DAVecRestoreArray(user[bi].da, Conc, &conc);
			VecDestroy(Conc);

/*
			PetscReal ***conc1;
			Vec Conc1;
			DACreateGlobalVector(user->da, &Conc1);
			//PetscViewer	viewer;
			sprintf(filen, "c1field%06d_%1d.dat", ti, user->_this);
			PetscViewerBinaryOpen(PETSC_COMM_WORLD, filen, FILE_MODE_READ, &viewer);
			VecLoadIntoVector(viewer, Conc1);
			PetscViewerDestroy(viewer);
			DAVecGetArray(user[bi].da, Conc1, &conc1);
			...
			DAVecRestoreArray(user[bi].da, Conc1, &conc1);
			VecDestroy(Conc1);


		        PetscReal ***conc2;
			Vec Conc2;
			DACreateGlobalVector(user->da, &Conc2);
			//PetscViewer	viewer;
			sprintf(filen, "c2field%06d_%1d.dat", ti, user->_this);
			PetscViewerBinaryOpen(PETSC_COMM_WORLD, filen, FILE_MODE_READ, &viewer);
			VecLoadIntoVector(viewer, Conc2);
			PetscViewerDestroy(viewer);
			DAVecGetArray(user[bi].da, Conc2, &conc2);
			...
			DAVecRestoreArray(user[bi].da, Conc2, &conc2);
			VecDestroy(Conc2);


			PetscReal ***conc3;
			Vec Conc3;
			DACreateGlobalVector(user->da, &Conc3);
			//PetscViewer	viewer;
			sprintf(filen, "c3field%06d_%1d.dat", ti, user->_this);
			PetscViewerBinaryOpen(PETSC_COMM_WORLD, filen, FILE_MODE_READ, &viewer);
			VecLoadIntoVector(viewer, Conc3);
			PetscViewerDestroy(viewer);
			DAVecGetArray(user[bi].da, Conc3, &conc3);
			...
			DAVecRestoreArray(user[bi].da, Conc3, &conc3);
			VecDestroy(Conc3);


			PetscReal ***conc4;
			Vec Conc4;
			DACreateGlobalVector(user->da, &Conc4);
			//PetscViewer	viewer;
			sprintf(filen, "c4field%06d_%1d.dat", ti, user->_this);
			PetscViewerBinaryOpen(PETSC_COMM_WORLD, filen, FILE_MODE_READ, &viewer);
			VecLoadIntoVector(viewer, Conc4);
			PetscViewerDestroy(viewer);
			DAVecGetArray(user[bi].da, Conc4, &conc4);
			...
			DAVecRestoreArray(user[bi].da, Conc4, &conc4);
			VecDestroy(Conc4);


			PetscReal ***conc5;
			Vec Conc5;
			DACreateGlobalVector(user->da, &Conc5);
			//PetscViewer	viewer;
			sprintf(filen, "c5field%06d_%1d.dat", ti, user->_this);
			PetscViewerBinaryOpen(PETSC_COMM_WORLD, filen, FILE_MODE_READ, &viewer);
			VecLoadIntoVector(viewer, Conc5);
			PetscViewerDestroy(viewer);
			DAVecGetArray(user[bi].da, Conc5, &conc5);
			...
			DAVecRestoreArray(user[bi].da, Conc5, &conc5);
			VecDestroy(Conc5);
*/
		}
	...
	for (bi=0; bi<block_number; bi++) {
		...
		if(pcr)  {
			...
			DAVecGetArray(user[bi].fda, user[bi].Ucat_square_sum, &u2sum);
                        if(levelset) {
                                      DAVecGetArray(user[bi].da, Level_sum, &level_sum);
                                      DAVecGetArray(user[bi].da, Level_square_sum, &level2sum);
                                     }
			...
			if(levelset){
                                     DAVecRestoreArray(user[bi].da, Level_sum, &level_sum);
			             DAVecRestoreArray(user[bi].da, Level_square_sum, &level2sum);
                                    }
...
//	PetscPrintf(PETSC_COMM_WORLD, "here!\n");
	...
	//PetscPrintf(PETSC_COMM_WORLD, "here!\n");
			...
			if(conv_diff) DAVecGetArray(user[bi].da, Conc_sum, &conc_sum);
			
                        if(levelset) DAVecGetArray(user[bi].da, Level_sum, &level_sum);
                        if(levelset) DAVecGetArray(user[bi].da, Level_square_sum, &level2sum);
			...
			if(conv_diff) DAVecRestoreArray(user[bi].da, Conc_sum, &conc_sum);
			if(levelset) DAVecRestoreArray(user[bi].da, Level_sum, &level_sum);
			if(levelset) DAVecRestoreArray(user[bi].da, Level_square_sum, &level2sum);
			...
			PetscViewerDestroy(viewer);
			DAVecGetArray(user[bi].da, lUstar_sum, &ustar_sum);
			...
			I = TECDAT100(&III, x, &DIsDouble);
                        ...
                        DAVecRestoreArray(user[bi].fda, user[bi].Ucat, &ucat);
	                DAVecRestoreArray(user[bi].da, lUstar_, &ustar_);
	                DAVecRestoreArray(user[bi].da, lUstar_sum, &ustar_sum);
	                VecDestroy(lUstar_);
...
int main(int argc, char **argv)
{
	...
	if(flag)sprintf(prefix, "%s_", tmp_str);
        ...
        PetscOptionsGetString(PETSC_NULL,"-grid", gridfname, 256, PETSC_NULL);
	...
	if (!flag) tsteps = 5; /* Default increasement is 5 */
        ...
        PetscOptionsGetInt(PETSC_NULL, "-temp", &tempOpt, &flag);


        // Option to output FTLE data
	PetscOptionsGetReal(PETSC_NULL, "-ftley", &ftley, &flag);
        if (!flag) ftleyFlg = false;
	PetscOptionsGetReal(PETSC_NULL, "-ftlez", &ftlez, &flag);
	...
	for (bi=0; bi<block_number; bi++) {
		...
		if(shear) {
			...
			DACreateGlobalVector(user[bi].fda, &user[bi].Ucat);
//canopy
                        DACreateGlobalVector(user[bi].fda, &user[bi].CnpyF);
                        DACreateGlobalVector(user[bi].da, &user[bi].CnpyNvert);
                        DACreateGlobalVector(user[bi].da, &user[bi].CnpyCdy);
 
			//if(conv_diff)DACreateGlobalVector(user[bi].da, &user[bi].Conc);
			if(!vc) DACreateGlobalVector(user[bi].fda, &user[bi].Ucat_o);
                        if (tempOpt)
                          DACreateGlobalVector(user[bi].da, &user[bi].Temp);
...
PetscErrorCode ReadCoordinates(UserCtx *user)
{
	...
	MPI_Comm_rank(PETSC_COMM_WORLD, &rank);
        ...
        PetscTruth flag;
	PetscReal	cl = 1.;
	PetscOptionsGetReal(PETSC_NULL, "-chact_leng", &cl, &flag);
        if (!flag)
