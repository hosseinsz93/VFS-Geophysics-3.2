CC	= mpicxx
  ...
  CPPFLAGS =          $(PETSC_INC) $(HYPREINC) $(MPI_INC) -DTECIO=1 $(OPTIMIZE) -std=c++11
...
LIBDIR= $(PETSC_DIR) $(HYPREDIR) $(BLAS_LAPACK_DIR)

LIBFLAG	=	-lpthread -lrt -ldl -lstdc++  \
		$(PETSC_LIB) $(HYPRELIB) $(BLAS_LAPACK_LIB) -lgfortran #-lX11
...
SOURCEC	=	bcs.c bmv.c compgeom.c ibm.c ibm_io.c init.c \
		...
		les.c k-omega.c distance.c level.c momentum.c \
                poisson_hypre.c rotor_model.c wallmodel.c tmprt.c \
                convection_diffusion.c sediment_transport.c MeshParms.c \
                TECOutput.c PrintSequential.c
...
OBJSC	=	bcs.o bmv.o compgeom.o ibm.o ibm_io.o init.o \
		...
		les.o k-omega.o distance.o level.o momentum.o poisson_hypre.o \
                rotor_model.o wallmodel.o tmprt.o convection_diffusion.o \
                sediment_transport.o MeshParms.o TECOutput.o PrintSequential.o

VFS-Geophysics-3.2CD:	$(OBJSC)
	$(CC) -o VFS-Geophysics-3.2CD $(OBJSC) $(CPPFLAGS) $(LIBDIR) $(LIBFLAG)

data-3.1: data.o
	$(CC) -o data-3.1 data.o $(CPPFLAGS) $(LIBDIR) $(LIBFLAG) tecio64.a
